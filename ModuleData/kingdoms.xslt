<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="Kingdom[@id='vlandia']/@name">
        <xsl:attribute name="name">Wilundinga Rice</xsl:attribute>
    </xsl:template>
	
	<xsl:template match="Kingdom[@id='vlandia']/@short_name">
        <xsl:attribute name="short_name">Wilundinga Rice</xsl:attribute>
    </xsl:template>
	...
	<xsl:template match="Kingdom[@id='sturgia']/@name">
        <xsl:attribute name="name">Sturgiskyy Knjazyvstvo</xsl:attribute>
    </xsl:template>
	
	<xsl:template match="Kingdom[@id='sturgia']/@short_name">
        <xsl:attribute name="short_name">Sturgiskyy Knjazyvstvo</xsl:attribute>
    </xsl:template>
	...
	<xsl:template match="Kingdom[@id='aserai']/@name">
        <xsl:attribute name="name">Saltanat al-Aserai</xsl:attribute>
    </xsl:template>
	
	<xsl:template match="Kingdom[@id='aserai']/@short_name">
        <xsl:attribute name="short_name">Saltanat al-Aserai</xsl:attribute>
    </xsl:template>
	...
	<xsl:template match="Kingdom[@id='khuzait']/@name">
        <xsl:attribute name="name">Khuzait Khaganlik</xsl:attribute>
    </xsl:template>
	
	<xsl:template match="Kingdom[@id='khuzait']/@short_name">
        <xsl:attribute name="short_name">Khuzait Khaganlik</xsl:attribute>
    </xsl:template>
	...
	<xsl:template match="Kingdom[@id='empire_w']/@name">
        <xsl:attribute name="name">Diktatoria ton Calradoi</xsl:attribute>
    </xsl:template>
	
	<xsl:template match="Kingdom[@id='empire_w']/@short_name">
        <xsl:attribute name="short_name">Diktatoria ton Calradoi</xsl:attribute>
    </xsl:template>
